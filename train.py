...
# Taken from: https://github.com/huggingface/diffusers/blob/main/examples/dreambooth/train_dreambooth_lora_flux_kontext.py
...
from diffusers.utils import check_min_version, convert_unet_state_dict_to_peft, load_image
...
def parse_args(input_args=None):
    ...
    parser.add_argument("--instance_data_dir", type=str, default=None, help=("A folder containing the training data. "))
